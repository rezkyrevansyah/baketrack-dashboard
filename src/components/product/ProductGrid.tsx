  ...
  return (
    <>
      {products.map((product) => (
        <div key={product.id} className="clay-card-static group relative flex items-center gap-6 p-6 !rounded-[32px] hover:scale-[1.02] transition-all duration-300 bg-white border border-pink-50/50">
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center justify-between">
               <div className="flex flex-col">
                  ...
                  <span className="text-xl font-black text-bakery-pink">{formatPrice(Number(product.price))}</span>
               </div>
