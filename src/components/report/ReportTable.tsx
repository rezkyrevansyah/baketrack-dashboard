...
export function ReportTable({
  ...
  return (
    <div className="space-y-6">
         <div className="flex flex-col md:flex-row md:items-end justify-between gap-4 px-2">
            <div>
               <h3 className="text-2xl font-black text-bakery-text flex items-center gap-2">
                 <img src="/icons/detail-transaksi.png" alt="Icon" className="w-8 h-8" /> {t('recent_transactions')}
         ...
         <div className="clay-card-static !bg-white rounded-2xl overflow-hidden border border-gray-100 p-0 shadow-sm">
